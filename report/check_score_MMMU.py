...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_path', type=str, default="/mnt/ccd/vlm-inference/results/inference_qwenvl2b_cot_summurize/MMMU/results.json", help="The path to model output file.")
    parser.add_argument('--answer_path', type=str, default="./data/MMMU/answer_dict_val.json", help="Answer file path.")
